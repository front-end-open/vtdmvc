        ...
        if (node.type === 1 /* ELEMENT */) {
            ...
            for (const prop of node.props) {
                if (prop.type === 7 /* DIRECTIVE */
                    ...
                    && prop.arg.isStatic) {
                    const propName = prop.arg.constType === 3 /* CAN_STRINGIFY */
                        ? prop.arg.content
                        : prop.arg.loc.source;
    ...
    function visitElementNode(node, parentEl) {
        ...
        function writeProps(node, forRemainStyleOrClass) {
            ...
            if (!forRemainStyleOrClass)
                startDiag = tsCodeGen.getText().length;
            tsCodeGen.addText(`{ `);
            for (const prop of node.props) {
                if (prop.type === 7 /* DIRECTIVE */
                    ...
                    const propName_1 = ((_b = prop.arg) === null || _b === void 0 ? void 0 : _b.type) === 4 /* SIMPLE_EXPRESSION */
            ...
            tsCodeGen.addText(` }`);
            if (!forRemainStyleOrClass)
                endDiag = tsCodeGen.getText().length;
            tsCodeGen.addText(`);\n`);
            ...
            function writeAttrValue(attrNode, propName) {
                if (attrNode) {
                    tsCodeGen.addText('"');
